 ...
 * Fixed to bottom of screen with three nav items.
 *
 * @param {"chat" | "projects" | "settings"} activeView - Current active view
 * @param {function} onNavigate - Callback when nav item is tapped
 */
